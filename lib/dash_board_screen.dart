...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  (_selectedIndex == 2 || _selectedIndex == 4) ? null :
      AppBar(
        ...
        actions: [
          ...
          InkWell(onTap: () {
          // Add your onTap action here, such as navigation or showing a dialog.
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.dashboard), label: 'Dashoard'),
